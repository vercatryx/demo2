...
export default async function ClientPortalPage({ params }: Props) {
  ...
  // For Food (or Produce head managing a Food/Meal household), portal uses only day-based meal plan
  // (clients.meal_planner_data). Do not pass upcoming_order so we never read/write it for that flow.
