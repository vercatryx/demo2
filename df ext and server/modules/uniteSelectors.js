/**
 * UNITE US WEBSITE SELECTORS (extension copy)
 * ===========================================
 * SOURCE OF TRUTH: server-side-automation/src/uniteSelectors.js
 * When selectors change, copy from there so extension and server stay in sync.
 * Same structure as server; exposes window.UNITE_SELECTORS for injection.
 */
...
(function () {
  ...
  // ---------------------------------------------------------------------------
  // BILLING PAGE (same as server billingActions.js / enterBillingDetails.js)
  // ---------------------------------------------------------------------------
  billing: {
    pageReady: {
