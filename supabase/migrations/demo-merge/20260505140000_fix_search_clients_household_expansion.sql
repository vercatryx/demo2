-- Household expansion must include parent and all dependents without re-applying Brooklyn filter:
-- the matched row already satisfied Brooklyn when p_brooklyn_only is true; expanded relatives may
-- differ on unite_account but must still appear together.
